...
export const Navbar: React.FC<NavbarProps> = ({ 
  ...
  const navItems: NavItem[] = [
    ...
    {
      name: 'Photo Gallery',
      subtitle: 'Studio photos, client transformations & store',
      page: 'gallery',
      icon: Image,
    },
    {
      name: 'About MagKay Spa',
      subtitle: 'Our story, team, hygiene standards & wellness values',
      page: 'about',
      icon: Award,
    },
    {
          ...
          <div className="max-w-7xl mx-auto px-3.5 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-14 sm:h-20 gap-2">
              ...
              <button 
                ...
                className="flex items-center gap-2 group text-left cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-[#DE1B76] rounded-xl p-0.5 transition-transform hover:scale-[1.01] shrink min-w-0"
              ...
              <div className="flex items-center gap-1.5 sm:gap-3 shrink-0">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1 sm:gap-2 bg-gradient-to-r from-[#DE1B76] to-[#c41566] hover:from-[#c41566] hover:to-[#a91256] active:scale-95 text-white px-2.5 sm:px-4 py-1.5 sm:py-2.5 rounded-full text-[11px] sm:text-xs font-bold uppercase tracking-wider shadow-md hover:shadow-lg hover:shadow-[#DE1B76]/30 transition-all duration-300 hover:scale-105 hover:-translate-y-0.5 cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-[#DE1B76] group shrink-0"
                  aria-label="Book an Appointment"
                >
                  <Calendar className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-white transition-transform duration-300 group-hover:scale-110" />
                  <span>Book</span>
                </button>
                ...
                >
                  ...
                  <span className="text-[11px] sm:text-xs font-bold uppercase tracking-wider sm:tracking-widest text-stone-200 group-hover:text-white transition-colors duration-200">
                    Menu
                  </span>
                </button>
              </div>
