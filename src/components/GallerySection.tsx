      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <button
              ...
              className={`px-5 py-2 rounded-full text-xs font-bold transition-all cursor-pointer ${
                selectedCategory === tab.id
                  ...
                  : 'bg-[#14141A] text-stone-400 hover:bg-stone-800 hover:text-white border border-stone-800'
              }`}
            >
              {tab.label}
            </button>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {filteredItems.map((item) => (
            <div
              ...
              className="group relative rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl bg-stone-900 aspect-[4/3] cursor-pointer transition-all duration-300 border border-stone-800"
            >
              <img
                src={item.image}
                alt={item.title}
              ...
              <div className="absolute top-3 right-3 bg-black/70 backdrop-blur-md px-3 py-1 rounded-full text-[11px] font-bold text-stone-200 flex items-center gap-1.5 border border-white/10 shadow-xs">
              ...
              <div className="absolute bottom-4 left-4 right-4 text-white space-y-1.5 text-left">
                ...
                <div className="pt-1 flex items-center gap-1 text-[11px] text-[#FF4B99] font-semibold">
        ...
        <div className="mt-12 text-center">
          <a
            ...
            className="inline-flex items-center gap-2 px-6 py-3.5 rounded-full bg-[#14141A] hover:bg-[#DE1B76] text-white border border-stone-800 text-xs font-bold uppercase tracking-wider shadow-lg hover:shadow-[#DE1B76]/25 transition-all group"
          >
            <Instagram className="w-4 h-4 text-[#DE1B76] group-hover:text-white transition-colors" />
