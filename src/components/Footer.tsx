      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 pb-12 border-b border-stone-800">
          ...
          <div className="lg:col-span-3 space-y-3 text-left">
            ...
            <div className="pt-2">
              <a
                id="footer-setmore-booking-btn"
                href={SPA_INFO.bookingUrl}
                target="_blank"
                rel="noopener noreferrer"
                className="w-full py-2.5 px-4 bg-[#DE1B76] hover:bg-[#c41566] active:scale-95 text-white rounded-xl text-xs font-bold uppercase tracking-wider flex items-center justify-center gap-2 shadow-lg shadow-[#DE1B76]/25 hover:scale-105 transition-all duration-300 cursor-pointer group"
              >
